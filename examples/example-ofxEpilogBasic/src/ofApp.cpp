...
void ofApp::keyPressed(int key){
    ...
    {
        // random chosen point
        p[0] = ofPoint(ofRandom(0, 100), ofRandom(0, 100));
        p[1] = ofPoint(ofRandom(0, 100), ofRandom(0, 100));
        p[2] = ofPoint(ofRandom(0, 100), ofRandom(0, 100));
        p[3] = ofPoint(ofRandom(0, 100), ofRandom(0, 100));
